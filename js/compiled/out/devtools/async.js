...
var o__30531__auto___31635 = (function (){var o__30531__auto__ = (function (){var o__30531__auto__ = Promise;
return goog.object.get(o__30531__auto__,"resolve").call(o__30531__auto__);
})();
return goog.object.get(o__30531__auto__,"then").call(o__30531__auto__,callback);
})();
goog.object.get(o__30531__auto___31635,"catch").call(o__30531__auto___31635,devtools.async.rethrow_outside_promise);
...
var G__31637_31638 = Error;
var target__30550__auto___31639 = G__31637_31638;
if(cljs.core.truth_(target__30550__auto___31639)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__31637_31638)].join('')),cljs.core.str("\n"),cljs.core.str("target__30550__auto__")].join('')));
}

goog.object.set(target__30550__auto___31639,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1498467845651