...
var reader = (function (){var or__26240__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__26240__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__26240__auto__)){
return or__26240__auto__;
} else {
return (128);
...
var map__31662 = top_item;
var map__31662__$1 = ((((!((map__31662 == null)))?((((map__31662.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31662.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31662):map__31662);
var file = cljs.core.get.call(null,map__31662__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__31662__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__31662__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e31661){var _e = e31661;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___31664 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___31664)){
var seen_errors_31665 = temp__4655__auto___31664;
if(cljs.core.truth_(seen_errors_31665.has(self))){
} else {
seen_errors_31665.add(self);

var temp__4657__auto___31666 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___31666)){
var sense_31667 = temp__4657__auto___31666;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_31667)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1498468271706