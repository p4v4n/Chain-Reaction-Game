...
var len__27315__auto___30892 = arguments.length;
var i__27316__auto___30893 = (0);
while(true){
if((i__27316__auto___30893 < len__27315__auto___30892)){
args__27322__auto__.push((arguments[i__27316__auto___30893]));

var G__30894 = (i__27316__auto___30893 + (1));
i__27316__auto___30893 = G__30894;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__27323__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30889){
var G__30890 = cljs.core.first.call(null,seq30889);
var seq30889__$1 = cljs.core.next.call(null,seq30889);
var G__30891 = cljs.core.first.call(null,seq30889__$1);
var seq30889__$2 = cljs.core.next.call(null,seq30889__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__30890,G__30891,seq30889__$2);
});
...
if(cljs.core.truth_((function (){var or__26240__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__26846__auto__,writer__26847__auto__,opt__26848__auto__){
return cljs.core._write.call(null,writer__26847__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__26228__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__26228__auto__){
var or__26240__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__26240__auto__)){
return or__26240__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30895_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__30895_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__30904__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__26240__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e30908){var e__30556__auto__ = e30908;
return false;
}})();
if(cljs.core.truth_(or__26240__auto__)){
return or__26240__auto__;
...
}catch (e30910){var e__30556__auto__ = e30910;
return false;
}}
})())){
...
var _STAR_current_state_STAR_30915 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__30916 = opts;
...
var markup_db = cljs.core.get.call(null,map__30916__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_30915;
}});
...
;
var temp__4655__auto___30921 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___30921)){
var managed_print_level_30922 = temp__4655__auto___30921;
var _STAR_print_level_STAR_30920_30923 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_30922;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_30920_30923,managed_print_level_30922,temp__4655__auto___30921,writer,opts,job_fn){
return (function (p1__30918_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__30918_SHARP_,null);
});})(_STAR_print_level_STAR_30920_30923,managed_print_level_30922,temp__4655__auto___30921,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_30920_30923;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1498467844112