...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__26846__auto__,writer__26847__auto__,opt__26848__auto__){
return cljs.core._write.call(null,writer__26847__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__27871 = o;
(G__27871[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__27872__delegate = function (args){
...
return G__27872__delegate.call(this,args);};
G__27872.cljs$lang$maxFixedArity = 0;
G__27872.cljs$lang$applyTo = (function (arglist__27874){
var args = cljs.core.seq(arglist__27874);
return G__27872__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__26228__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__26228__auto__){
var and__26228__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__27880 = jsprops;
(G__27880["defaultValue"] = value);

(G__27880["onChange"] = ((function (G__27880,v,value,on_change){
return (function (p1__27877_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__27877_SHARP_);
});})(G__27880,v,value,on_change))
);

(G__27880["ref"] = ((function (G__27880,v,value,on_change){
return (function (p1__27878_SHARP_){
return (this$["cljsInputElement"] = p1__27878_SHARP_);
});})(G__27880,v,value,on_change))
);
...
var vec__27887 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27887,(0),null);
var id = cljs.core.nth.call(null,vec__27887,(1),null);
var class$ = cljs.core.nth.call(null,vec__27887,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___27892 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___27892 == null)){
} else {
var key_27893 = temp__4661__auto___27892;
(jsprops["key"] = key_27893);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__27895 = (new reagent.impl.template.NativeWrapper());
(G__27895["name"] = c);
...
var len__27315__auto___27901 = arguments.length;
var i__27316__auto___27902 = (0);
while(true){
if((i__27316__auto___27902 < len__27315__auto___27901)){
args__27322__auto__.push((arguments[i__27316__auto___27902]));

var G__27903 = (i__27316__auto___27902 + (1));
i__27316__auto___27902 = G__27903;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27323__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq27899){
var G__27900 = cljs.core.first.call(null,seq27899);
var seq27899__$1 = cljs.core.next.call(null,seq27899);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__27900,seq27899__$1);
});
...
break;
default:
var G__27907 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__27907;
continue;
...
var n__27155__auto___27910 = a.length;
var i_27911 = (0);
while(true){
if((i_27911 < n__27155__auto___27910)){
(a[i_27911] = reagent.impl.template.as_element.call(null,(a[i_27911])));

var G__27912 = (i_27911 + (1));
i_27911 = G__27912;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__27155__auto___27913 = a.length;
var i_27914 = (0);
while(true){
if((i_27914 < n__27155__auto___27913)){
var val_27915 = (a[i_27914]);
if((cljs.core.vector_QMARK_.call(null,val_27915)) && ((reagent.impl.template.key_from_vec.call(null,val_27915) == null))){
(o["no-key"] = true);
} else {
}

(a[i_27914] = reagent.impl.template.as_element.call(null,val_27915));
...
var ctx = ({});
var vec__27920 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__27920,(0),null);
var derefed = cljs.core.nth.call(null,vec__27920,(1),null);
...
var G__27924 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27924) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__27924){
...
//# sourceMappingURL=template.js.map?rel=1498467837856