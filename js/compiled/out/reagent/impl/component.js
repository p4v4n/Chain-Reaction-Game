...
if((i < len)){
var k = (ks[i]);
var G__27804 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__27805 = (i + (1));
m = G__27804;
i = G__27805;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__27809 = c;
var G__27809__$1 = (((G__27809 == null))?null:G__27809.prototype);
if((G__27809__$1 == null)){
return null;
} else {
return (G__27809__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__27813 = c;
var G__27813__$1 = (((G__27813 == null))?null:G__27813.prototype);
if((G__27813__$1 == null)){
return null;
} else {
return (G__27813__$1["render"]);
}
})()));
});
...
var G__27818__i = 0, G__27818__a = new Array(arguments.length -  0);
while (G__27818__i < G__27818__a.length) {G__27818__a[G__27818__i] = arguments[G__27818__i + 0]; ++G__27818__i;}
  args = new cljs.core.IndexedSeq(G__27818__a,0);
} 
return G__27817__delegate.call(this,args);};
G__27817.cljs$lang$maxFixedArity = 0;
G__27817.cljs$lang$applyTo = (function (arglist__27819){
var args = cljs.core.seq(arglist__27819);
...
var _STAR_current_component_STAR_27822 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_27822;
}});
...
var G__27826 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__27826) {
...
var or__26240__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__27828_27830 = (c["cljsRatom"]);
if((G__27828_27830 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__27828_27830);
}
...
if(cljs.core.truth_((function (){var and__26228__auto__ = wrap;
...
if(((1) === cljs.core.count.call(null,renders_27833))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_27834)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_27834))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__26240__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__26240__auto__)){
return or__26240__auto__;
} else {
...
var render_fun__$1 = (function (){var or__26240__auto__ = render_fun;
if(cljs.core.truth_(or__26240__auto__)){
return or__26240__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__26240__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__26240__auto__)){
return or__26240__auto__;
} else {
...
var name__$1 = (function (){var G__27832 = name;
switch (G__27832) {
case "":
...
var G__27837 = o;
(G__27837[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__27843 = (function (){var or__26240__auto__ = (function (){var G__27845 = c;
if((G__27845 == null)){
return null;
} else {
return (G__27845["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__26240__auto__)){
return or__26240__auto__;
...
return (G__27843["_currentElement"]);
}
})();
var name = (function (){var G__27846 = elem;
var G__27846__$1 = (((G__27846 == null))?null:(G__27846["type"]));
if((G__27846__$1 == null)){
return null;
} else {
return (G__27846__$1["displayName"]);
}
})();
var path = (function (){var G__27847 = elem;
var G__27847__$1 = (((G__27847 == null))?null:(G__27847["_owner"]));
var G__27847__$2 = (((G__27847__$1 == null))?null:reagent$impl$component$component_path.call(null,G__27847__$1));
if((G__27847__$2 == null)){
return null;
} else {
return [cljs.core.str(G__27847__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__26240__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__26240__auto__)){
return or__26240__auto__;
} else {
var G__27849 = c;
var G__27849__$1 = (((G__27849 == null))?null:G__27849.constructor);
if((G__27849__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__27849__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1498468263573